...
class _RegistrationState extends State<Registration> {
            ...
            children: [
              ...
              Container(
                  ...
                  child: TextField(
                    ...
                    onSubmitted: (value) {
                      setState(
                          () => textControllerConfirmPassword.text = value);
  ...
  ValidateAlert(BuildContext context) async {
    if (textControllerFirstName.text.isEmpty ||
        textControllerAddress.text.isEmpty ||
        textControllerPassword.text.isEmpty ||
        textControllerConfirmPassword.text.isEmpty ||
      ...
      _checkNumber('+92${textControllerPhone.text}');
    }
  }
  ...
  _checkNumber(String phone) {
    FirebaseFirestore.instance
      ...
      print(error);
      _checkemail(textControllerEmail.text);
    });
  }

  RegiterEmailAlert(BuildContext context) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return Center(
          child: AlertDialog(
            title: Text('This email address is already in use by other user'),
            actions: <Widget>[
              FlatButton(
                child: Text("ok"),
                onPressed: () {
