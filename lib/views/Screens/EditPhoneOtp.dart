...
class EditPhoneOTpScreen extends StatefulWidget {
  final String phone;

  const EditPhoneOTpScreen( {Key key, this.phone}) : super(key: key);
  @override
  _EditPhoneOTpScreenState createState() => _EditPhoneOTpScreenState();
}

class _EditPhoneOTpScreenState extends State<EditPhoneOTpScreen> {
  ...
  void _onPressed(String phone){
    var firebaseUser = FirebaseAuth.instance.currentUser;
    FirebaseFirestore.instance
        .collection("users")
        .doc(firebaseUser.uid)
        .update({ "phone": '+92${phone}'}).then((_) {
      print("success!");
    });
  }
}
